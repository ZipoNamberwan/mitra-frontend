                ...
                <div class="header-body text-center mb-5">
                    <div class="row justify-content-center">
                        <div class="col-xl-5 col-lg-6 col-md-8 px-5">
                            <img src="/assets/img/bps.svg" class="logoregister">
                            <h1 class="text-white">Aplikasi Mitra BPS Kabupaten Probolinggo</h1>
                            <h2 class="text-white">Registrasi Akun Baru</h2>
                            <p class="text-lead text-white">Isi Form Biodata Pendaftaran di Bawah ini</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="email" value="{{$email}}" disabled class="form-control @error('email') is-invalid @enderror">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            <label class="form-control-label" for="validationCustom03">Nama Lengkap <span class="text-danger">*</span></label>
                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="validationCustom03" value="{{ @old('name', $name) }}">
                                            @error('name')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            <label class="form-control-label" for="phone">Nomor Handphone <span class="text-danger">*</span></label>
                                    ...
                                    <div class="col-md-6">
                                        <div class="col-md-14 mb-3">
                                            <label class="form-control-label">Pendidikan <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            <label class="form-control-label" for="validationCustom03">Profesi <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            <label class="form-control-label" for="validationCustom03">Alamat <span class="text-danger">*</span></label>
                                        ...
                                        @enderror
                                        <button type="submit" class="btn btn-primary mt-3" value="Simpan">Daftar</button>
                                    </div>
                                </div>
                            </form>
                        </div>

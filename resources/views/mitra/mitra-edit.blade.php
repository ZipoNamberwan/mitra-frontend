                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="name"
                                                ...
                                                id="validationCustom03" value="{{ @old('name', $mitra->name) }}">
                                            @error('name')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="nickname"
                                                ...
                                                id="validationCustom03" value="{{ @old('nickname', $mitra->nickname) }}">
                                            @error('nickname')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <img class="img-preview img-fluid mb-3 col-sm-5 image-preview"
                                                src="@if ($mitra->photo != null) {{ asset('storage/' . $mitra->photo) }} @endif" style="display:block">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                                <input name="sex" class="custom-control-input" id="sex_radio1" value="L"
                                                    type="radio" {{ old('sex', $mitra->sex) == 'L' ? 'checked' : '' }}>
                                            ...
                                            <div class="custom-control custom-radio mb-3">
                                                <input name="sex" class="custom-control-input" id="sex_radio2" value="P"
                                                    type="radio" {{ old('sex', $mitra->sex) == 'P' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-14 mb-3">
                                            ...
                                            <input type="text" name="address"
                                                ...
                                                id="validationCustom03" value="{{ @old('address', $mitra->address) }}">
                                            @error('address')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
